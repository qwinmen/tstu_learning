using System;
//http://optimizaciya-sapr.narod.ru/bez_odnomer/fibonachhi.html
namespace Decoder
{
    class ЧислаФибоначчи
    {
        static int[] ЧислаФибо=new int[10];
        ...
        public static void Фибоначи(double a0,double b0,double epsilon, double l)
        {
            double n = (b0 - a0)/l;//10
            int N = Fibo(n), k = 0;
            double f_y, f_z;
