...
namespace Ribbonpad
{
	...
	public class frmMain : DevComponents.DotNetBar.RibbonForm
    {
		...
		private void InitializeComponent()
		{
            ...
            this.textBoxX_TextCriptoIn.WatermarkText = "Что шифровать?";
        ...
        {
            //Введенная фраза до пробела разбивается на символы
            //Ищем эти символы в загруженном документе
            //Изменяем тип Шрифта на Courier символа
            //Изменяем тип Шрифта на Умолчание документа
