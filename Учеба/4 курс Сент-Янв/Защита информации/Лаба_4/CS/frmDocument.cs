...
namespace Ribbonpad
{
	...
	public class frmDocument : DevComponents.DotNetBar.OfficeForm
	{
		...
		private void InitializeComponent()
		{
            ...
            this.CommandDelete = new DevComponents.DotNetBar.Command(this.components);
            this.CommandSelectAll = new DevComponents.DotNetBar.Command(this.components);
            this.CommandFindNext = new DevComponents.DotNetBar.Command(this.components);
            this.CommandReplace = new DevComponents.DotNetBar.Command(this.components);
            this.CommandStatus = new DevComponents.DotNetBar.Command(this.components);
            ...
            this.CommandFontStrike = new DevComponents.DotNetBar.Command(this.components);
            this.CommandAlignLeft = new DevComponents.DotNetBar.Command(this.components);
            this.CommandAlignCenter = new DevComponents.DotNetBar.Command(this.components);
            this.CommandAlignRight = new DevComponents.DotNetBar.Command(this.components);
            this.CommandTextColor = new DevComponents.DotNetBar.Command(this.components);
            this.CommandFind = new DevComponents.DotNetBar.Command(this.components);
            this.CommandFont = new DevComponents.DotNetBar.Command(this.components);
            this.CommandFontSize = new DevComponents.DotNetBar.Command(this.components);
		...
		{
			UpdateStatusBar();
            if (rtfText.SelectionFont == null)return;
		    ...
		    catch (Exception)
		    {
                ...
                rtfText.SelectionFont = new Font("Times New Roman", 14f);
                CommandFontBold.Checked = rtfText.SelectionFont.Bold;
		    }
        ...
        /// <summary>
        /// Перед закрытием предложить сохранить изменения
        /// </summary>
		...
		private void CommandFont_Executed(object sender, EventArgs e)
		{
			...
			if (combo != null && combo.SelectedItem != null)
			{
				try
				{
                    //Определить тип шрифта в комбоБоксе
					Font font = new Font(combo.SelectedItem.ToString(), rtfText.SelectionFont.Size);
                    //Применить выбранное для выделеного участка текста
        ...
        /// <summary>
        /// Произошло изменение в документе
        /// </summary>
