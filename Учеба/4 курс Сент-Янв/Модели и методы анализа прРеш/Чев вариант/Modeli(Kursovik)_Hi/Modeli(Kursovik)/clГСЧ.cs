...
namespace Sluch
    ...
    {
        //ламбда 1
        private string _l1 = 0.2549.ToString();
        //лямбда 2
        private string _l2 = 0.1417.ToString();
        private double _m = 2.1;
        private int _N = 200;
        //дисперсия:
        private string _G0 = 12.ToString();
        private string _a0 = 0.1.ToString();
        //задать 1
        private string _A1 = 1.ToString();
        //задать 1
        private string _A2 = 1.ToString();
        //математическое ожидание:
        private string _M0 = 15.ToString();//12.ToString();
        //количество значений кореляционой функции:
        ...
        internal string[] ГСЧрезульт { get; set; }
