...
void GLWidget::manual(){

    timer->stop();

}
void GLWidget::trancletedGL(int tvalue){
...
void GLWidget::rotation(int tvalue){
...
void GLWidget::touching(int trancleted){
    ...
    if((radiusBig - (radiuSmall - toothsizeSmall + trancleted )) > 0 && (radiusBig - (radiuSmall - toothsizeSmall + trancleted)) < 3)
        contact = true;
    else
        contact = false;
...
void GLWidget::initializeGL(){
    ...
    static const GLfloat reflectance1[4] = { 1.0f, 0.51f, 0.23f, 1.0f };
    static const GLfloat reflectance2[4] = { 0.95f, 0.77f, 0.19f, 1.0f };
    static const GLfloat reflectance3[4] = { 0.92f, 0.46f, 0.0f, 1.0f };
...
void GLWidget::paintGL(){
    ...
    glPushMatrix();
    glTranslated(trancleted, 0.0, 0.0);

    if (rotat == 0)
        drawGear(gear1, -3.0, -2.0, 0.0, gear1Rot / 16.0);
    else
        drawGear(gear1, -3.0, -2.0, 0.0, rotat);
    ...
    if (rotat == 0)
        ...
        drawGear(gear3, -3.1, -1.8, -2.2, +2.0 * (rotat) - 2.0);
    ...
    if (rotat == 0)
        ...
        drawGear(gear2, +3.1, -2.0, 0.0, -2.0 * (rotat) - 9.0);
...
GLuint GLWidget::makeGear(const GLfloat *reflectance, GLdouble innerRadius, GLdouble outerRadius, GLdouble thickness, GLdouble toothSize, GLint toothCount){
