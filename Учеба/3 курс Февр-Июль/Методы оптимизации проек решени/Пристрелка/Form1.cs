...
namespace Пристрелка
{
    public partial class Form1 : Office2007Form
    {
        ...
        private double Progon(PointD xt0, PointD xt1)
        {
            ...
            {
                index++;
                z.Add(z[index - 1] - i * doubleInput_step.Value);//z[index] = z[index - 1] - i * doubleInput_step.Value;
                x.Add(x[index - 1] + z[index - 1] * doubleInput_step.Value);//x[index] = x[index - 1] + z[index - 1] * doubleInput_step.Value;
