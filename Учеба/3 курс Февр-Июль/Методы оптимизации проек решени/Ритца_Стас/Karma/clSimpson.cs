...
namespace Karma
{
    ...
    class clSimpson
    {
        ...
        public static double Simpson(double a1, double a2)
        {
            ...
            {
                double proizvodX = Form1.ПроизводнаяПоИкс(a1, tt, tt + delta);//
                производныеX.Add(proizvodX);

                double proizvodY = Form1.ПроизводнаяПоИгрек(a2, tt, tt + delta);//
            ...
            {
                //t=[0.0; 1.0]
                double integrl = Simpson(2, производныеX[index], производныеY[index]);
