...
namespace Сам
{
    public partial class Form1 : Form
    {
        ...
        private PointPair4 _1;
        private PointPair4 _2;
        private PointPair4 _3;
        private PointPair4 _4;

        private PointPair4 _5;
        private PointPair4 _6;
        private PointPair4 _7;
        private PointPair4 _8;

        private PointPair4 _9;
        private PointPair4 _10;
        private PointPair4 _11;
        private PointPair4 _12;

        private PointPair4 _13;
        private PointPair4 _14;
        private PointPair4 _15;
        private PointPair4 _16;
        ...
        private clModel mod = new clModel();
        ...
        public Form1()
        {
            ...
            _5 = mod._5; _6 = mod._6;
            _7 = mod._7; _8 = mod._8;
            _9 = mod._9; _10 = mod._10;
            _11 = mod._11; _12 = mod._12;
            ...
            zedGraphControl_XY.GraphPane.YAxis.Title.Text = "Ось T";
            zedGraphControl_XY.GraphPane.XAxis.Title.Text = "Ось z";

            zedGraphControl_XZ.GraphPane.Title.Text = "";
            zedGraphControl_XZ.GraphPane.YAxis.Title.Text = "Ось t";
            zedGraphControl_XZ.GraphPane.XAxis.Title.Text = "Ось z";

            zedGraphControl_YZ.GraphPane.Title.Text = "";
            zedGraphControl_YZ.GraphPane.YAxis.Title.Text = "Ось T";
            zedGraphControl_YZ.GraphPane.XAxis.Title.Text = "Ось t";
        ...
        private void SetPointCurve(double x, double y, ZedGraphControl zedGraph, int flag)
        {
            ...
            _pane.XAxis.Scale.MinAuto = true;//pane.XAxis.Scale.Min = xmin_limit;
            _pane.XAxis.Scale.MaxAuto = true;//pane.XAxis.Scale.Max = xmax_limit;

            // !!!
            // Устанавливаем интересующий нас интервал по оси Y
            _pane.YAxis.Scale.MinAuto = true;//pane.YAxis.Scale.Min = ymin_limit;
