...
namespace vectShapes
{
    public partial class Form1 : Form
    {
        ...
        private void myInit()
        {
            ...
            this.toolBox1.setVectShape(this.userControl11);//контрол toolBox.cs - инструменты

        }

        private void Form1_Load(object sender, EventArgs e)
        {
            //this.userControl11.r = this.richTextBox1;

            //userControl11.Scale(new SizeF(2f,2f));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            myGraphics = this.userControl11.CreateGraphics();  //.CreateGraphics();
            myGraphics.FillEllipse(myBrush, new Rectangle(0, 0, 10, 10));
            myBrush.Dispose();
            myGraphics.Dispose();
        }
