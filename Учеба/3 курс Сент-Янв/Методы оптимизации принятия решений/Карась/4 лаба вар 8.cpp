...
//Функция ограничения 1
double f1(double x, double y)
{
	return 2*x+y-8;//типо 4 варик: x1*x1 + x2*x2 - 16 <= 0//52 stt
	double e = M_E;

	return y*pow(e, x) - x*x;//типо 8 варик: x2*e^x1 - x1*x1
}

//Функция ограничения 2
double f2(double x, double y)
{
    //return x+y;//типо вар 4: x1 - x2 sin(x1) + 1 <= 0//52 str
	return x+y+1;//типо вар 8: x1 + x2 + 1 >= 0
}
